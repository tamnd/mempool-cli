...
Most of these come down to network reality or how mempool serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mempool rate-limits like any public site. mempool already paces
...
Where a surface is gated, mempool reads a cookie or token you supply
...
`mempool`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mempool actually did
